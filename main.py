...
def serialize_user_inspector_data(u: User, state: MarketState, now: float, db: Optional[Session] = None) -> Dict[str, Any]:
    ...
    items = {
        ...
        "shield_100_scroll_count": getattr(u, "shield_100_scroll_count", 0) or 0,
        "boost_scroll_count": getattr(u, "boost_scroll_count", 0) or 0,
        "downgrade_scroll_count": getattr(u, "downgrade_scroll_count", 0) or 0,
        "downgrade_100_scroll_count": getattr(u, "downgrade_100_scroll_count", 0) or 0,
        ...
        "arm_shield_100": getattr(u, "arm_shield_100", True),
        "arm_downgrade": getattr(u, "arm_downgrade", True),
        "arm_downgrade_100": getattr(u, "arm_downgrade_100", True),
    ...
    return {
        ...
        "treasury_donation_total": getattr(u, "treasury_donation_total", 0) or 0,
        "credit": credit_info,
        "bank": bank_info,
