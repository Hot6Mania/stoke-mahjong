...
class User(Base):
    ...
    shield_100_scroll_count = Column(Integer, default=0, nullable=False)
    downgrade_100_scroll_count = Column(Integer, default=0, nullable=False)
    ...
    arm_shield_100 = Column(Boolean, default=True, nullable=False)
...
class MarketState(Base):
    ...
    merchant_shield_100_price = Column(Integer, default=15000000, nullable=True)
    merchant_shield_100_stock = Column(Integer, default=0, nullable=True)
    merchant_downgrade_100_price = Column(Integer, default=10000000, nullable=True)
    merchant_downgrade_100_stock = Column(Integer, default=0, nullable=True)
